...
const getVariantStyles = (variant: string = 'default') => {
  switch (variant) {
    case 'primary': return 'border-[var(--tp-accent)]/30 border-t-[var(--tp-accent)]';
    case 'secondary': return 'border-[var(--text-secondary)]/30 border-t-[var(--text-secondary)]';
    case 'accent': return 'border-[var(--tp-accent)]/30 border-t-[var(--tp-accent)]';
    case 'destructive': return 'border-[var(--df-destructive)]/30 border-t-[var(--df-destructive)]';
    case 'ghost': return 'border-[var(--text-muted)]/30 border-t-[var(--text-muted)]';
    default: return 'border-[var(--tp-accent)]/30 border-t-[var(--tp-accent)]';
  }
};
