...
>(({ className, effects = 'on', children, ...props }, ref) => (
  <NavigationMenuPrimitive.Trigger
    ref={ref}
    className={cn(quantumGateEffectsClass(effects), navigationMenuTriggerStyle(), 'group', className)}
...
>(({ className, effects = 'on', ...props }, ref) => (
  <div className={cn(quantumGateEffectsClass(effects), 'absolute left-0 top-full flex justify-center')}>
    <NavigationMenuPrimitive.Viewport
      className={cn(quantumGateEffectsClass(effects), 
        'origin-top-center relative mt-1.5 h-[var(--radix-navigation-menu-viewport-height)] w-full overflow-hidden border border-[var(--qg-border)] bg-[var(--qg-surface)] text-[var(--text-primary)] shadow data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-90 md:w-[var(--radix-navigation-menu-viewport-width)] ',
        className
      )}
      ref={ref}
      style={{ } as React.CSSProperties}
...
>(({ className, effects = 'on', ...props }, ref) => (
  <NavigationMenuPrimitive.Indicator
    ...
    {...props}
  >
    <div className="relative top-[60%] h-2 w-2 rotate-45 rounded-tl-sm bg-[var(--qg-border)] shadow-md" />
  </NavigationMenuPrimitive.Indicator>
));
