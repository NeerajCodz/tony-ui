...
export function Avatar({
  ...
  const baseStyles = "relative transition-all duration-200 shadow-md active:shadow-sm active:translate-y-0.5 relative flex h-10 w-10 shrink-0 overflow-hidden rounded-full";
