...
const AngularCornerToggle = forwardRef<React.ElementRef<typeof TogglePrimitives.Root>, React.ComponentPropsWithoutRef<typeof TogglePrimitives.Root> & { colors?: VariantColors; version?: string }>(
...
AngularCornerToggle.displayName = 'AngularCornerToggle';

export default AngularCornerToggle;
