...
export default function Label({
  ...
  const baseStyles = "relative text-lg p-6 transition-all duration-200 text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70";
