...
const CLIP_PATH = 'polygon(15px 0, 100% 0, 100% calc(100% - 15px), calc(100% - 15px) 100%, 0 100%, 0 15px)';
...
case 'default':
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 left-0 w-4 h-4 border-t-2 border-l-2 opacity-70" style={{ borderColor: `var(--${color})` }} />
      <div className="absolute bottom-0 right-0 w-4 h-4 border-b-2 border-r-2 opacity-70" style={{ borderColor: `var(--${color})` }} />
...
Component.displayName = 'Chart-angular-corner';
