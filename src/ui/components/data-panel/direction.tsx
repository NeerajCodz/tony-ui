...
const Component = React.forwardRef<HTMLDivElement, DirectionProps>(({ direction = 'right', size = 'md', className, version = 'data-panel', variant = 'primary', type = 'default', animated = true, children, ...props }, ref) => {
