...
import type { KbdProps } from '../../types/components/misc.js'; // Adjust path if needed

const CLIP_PATH = 'polygon(8px 0, calc(100% - 8px) 0, 100% 8px, 100% calc(100% - 16px), calc(100% - 16px) 100%, 16px 100%, 0 calc(100% - 8px), 0 8px)';

const Component = React.forwardRef<HTMLButtonElement, KbdProps>(({
  variant = 'neutral',
  type = 'default',
  animated = true,
  className = '',
...
Component.displayName = 'Kbd-holo-frame';
