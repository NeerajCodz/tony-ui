...
export const Overlay = React.forwardRef(({ className, version = 'neon-outline', ...props }: any, ref: any) => (
...
export const Content = React.forwardRef(({ className, children, version = 'neon-outline', variant = 'primary', ...props }: any, ref: any) => {
...
export const Title = React.forwardRef(({ className, version = 'neon-outline', variant = 'primary', ...props }: any, ref: any) => {
  const color = variantColors[variant as keyof typeof variantColors] || 'cyan';
...
export const Description = React.forwardRef(({ className, version = 'neon-outline', variant = 'primary', ...props }: any, ref: any) => {
  const color = variantColors[variant as keyof typeof variantColors] || 'cyan';
