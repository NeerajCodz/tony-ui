...
const versionComponents = {
  'angular-corner': lazy(() => import('./button-angular-corner')),
  'holo-frame': lazy(() => import('./button-holo-frame')),
  'data-panel': lazy(() => import('./button-data-panel')),
  'circuit-board': lazy(() => import('./button-circuit-board')),
  'quantum-gate': lazy(() => import('./button-quantum-gate')),
  'tactical-hud': lazy(() => import('./button-tactical-hud')),
  'energy-shield': lazy(() => import('./button-energy-shield')),
  'terminal-window': lazy(() => import('./button-terminal-window')),
  'matrix-grid': lazy(() => import('./button-matrix-grid')),
  'neon-outline': lazy(() => import('./button-neon-outline')),
};
...
`;
  ...
  fs.writeFileSync(path.join(targetDir, `button-${version}.tsx`), versionContent);
});
