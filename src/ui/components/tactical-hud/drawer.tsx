...
export const Overlay = React.forwardRef(({ className, version = 'tactical-hud', ...props }: any, ref: any) => (
...
export const Content = React.forwardRef(({ className, children, version = 'tactical-hud', type = 'default', variant = 'primary', ...props }: any, ref: any) => {
...
export const Title = React.forwardRef(({ className, version = 'tactical-hud', type = 'default', variant = 'primary', ...props }: any, ref: any) => {
  const color = variantColors[variant as keyof typeof variantColors] || 'cyan';
...
export const Description = React.forwardRef(({ className, version = 'tactical-hud', type = 'default', variant = 'primary', ...props }: any, ref: any) => {
  const color = variantColors[variant as keyof typeof variantColors] || 'cyan';
