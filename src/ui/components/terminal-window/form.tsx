...
>(({ className, effects = 'on', ...props }, ref) => {
  ...
  return (
    <Label
      ref={ref}
      className={cn(terminalWindowEffectsClass(effects), error && 'text-[var(--tm-red)]', className)}
      htmlFor={formItemId}
      {...props}
    />
  );
...
const FormDescription = React.forwardRef<
  ...
  React.HTMLAttributes<HTMLParagraphElement> & { effects?: TerminalWindowEffects }
>(({ className, effects = 'on', ...props }, ref) => {
