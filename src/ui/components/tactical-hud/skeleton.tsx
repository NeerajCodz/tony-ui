/**
 * Skeleton - Tactical HUD Version
 * Loading placeholder with tactical HUD styling
 */
...
export const Skeleton: React.FC<SkeletonProps> = ({
  ...
  const styles: React.CSSProperties = {
    ...
    position: 'relative',
    ...(animated && {
      animation: 'skeleton-pulse 1.5s ease-in-out infinite, skeleton-scan 2s linear infinite',
    }),
    ...style,
  };
...
Skeleton.displayName = 'TacticalHudSkeleton';
