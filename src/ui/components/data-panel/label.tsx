...
export default function Label({
  ...
  const baseStyles = "relative font-mono transition-all duration-200 border-l-4 text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70";
