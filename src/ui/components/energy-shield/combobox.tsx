                  ...
                  <CommandGroup>
                    {options.map((option) => (
                      ...
                      >
                        <Check
                          className={cn(energyShieldEffectsClass(effects), 
                            'mr-2 h-4 w-4 text-[var(--es-plasma-1)]',
...
export const ComboboxTrigger = React.forwardRef<HTMLButtonElement, React.ButtonHTMLAttributes<HTMLButtonElement> & { effects?: EnergyShieldEffects }>(
