...
const DataTable = <TData, TValue>({
  ...
  return (
    <div className={cn("w-full overflow-hidden", className)} style={{
      border: `1px solid hsl(var(--${color}-base))`, background: 'black', boxShadow: `0 0 10px hsl(var(--${color}-base) / 0.5)`
    , ...typeStyles}}>
      <div 
      ...
      >
        <table className="w-full caption-bottom text-sm">
          <thead style={{
             borderBottom: `1px solid hsl(var(--${color}-base))`, textShadow: `0 0 5px hsl(var(--${color}-base))`
          , ...typeStyles}}>
