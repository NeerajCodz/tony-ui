      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-12">
          <h1 className="text-4xl font-bold mb-4 text-cyan-400 font-mono tracking-tighter">
            Sonner <span className="text-gray-600 text-2xl">// Component Showcase</span>
          </h1>
          <p className="text-gray-400 max-w-2xl">
            Cyber-aesthetic versions of the Sonner component. 
              ...
              {versions.map(version => (
                <div key={version} className="p-6 border border-gray-800 rounded-lg bg-gray-900/50 flex flex-col gap-4">
                  ...
                  <div className="flex items-center justify-center min-h-[60px]">
                    {/* Overlay trigger would go here */}
                     <Sonner 
                      version={version} 
                      variant={currentVariant}
                      type={currentType}
                    >
                      <div className="p-4 bg-gray-800 text-white border border-gray-700 rounded cursor-pointer">
                        Open {version} Sonner
                      </div>
                    </Sonner>
                  </div>
