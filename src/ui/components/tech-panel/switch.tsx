...
const TechPanelSwitch = forwardRef<React.ElementRef<typeof SwitchPrimitives.Root>, SwitchProps>(
...
TechPanelSwitch.displayName = 'TechPanelSwitch';

export default TechPanelSwitch;
