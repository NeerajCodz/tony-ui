...
const versionComponents = {
  'angular-corner': lazy(() => import('./textarea-angular-corner')),
  'holo-frame': lazy(() => import('./textarea-holo-frame')),
  'data-panel': lazy(() => import('./textarea-data-panel')),
  'circuit-board': lazy(() => import('./textarea-circuit-board')),
  'quantum-gate': lazy(() => import('./textarea-quantum-gate')),
  'tactical-hud': lazy(() => import('./textarea-tactical-hud')),
  'energy-shield': lazy(() => import('./textarea-energy-shield')),
  'terminal-window': lazy(() => import('./textarea-terminal-window')),
  'matrix-grid': lazy(() => import('./textarea-matrix-grid')),
  'neon-outline': lazy(() => import('./textarea-neon-outline')),
};
...
`;
  ...
  fs.writeFileSync(path.join(targetDir, `textarea-${version}.tsx`), versionContent);
});

console.log('Textarea regeneration complete.');
