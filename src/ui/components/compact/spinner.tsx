...
const getSizeStyles = (size: string = 'md') => {
  switch (size) {
    ...
    case 'sm': return 'h-4 w-4 border';
    case 'md': return 'h-6 w-6 border';
    case 'lg': return 'h-9 w-9 border-[3px]';
    case 'xl': return 'h-12 w-12 border-4';
    default: return 'h-6 w-6 border';
  }
};

const getVariantStyles = (variant: string = 'default') => {
  switch (variant) {
    case 'primary': return 'border-[var(--cp-accent)]/30 border-t-[var(--cp-accent)]';
    case 'secondary': return 'border-[var(--text-secondary)]/30 border-t-[var(--text-secondary)]';
    case 'accent': return 'border-[var(--cp-accent)]/30 border-t-[var(--cp-accent)]';
    ...
    default: return 'border-[var(--cp-accent)]/30 border-t-[var(--cp-accent)]';
  }
};
