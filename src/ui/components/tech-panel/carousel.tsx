    ...
    return (
      ...
      >
        <div
          ...
          className={cn(techPanelEffectsClass(effects), 'relative', className)}
          role="region"
...
const CarouselContent = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement> & { effects?: TechPanelEffects }>(
  ({ className, effects = 'on', ...props }, ref) => {
    const { orientation } = React.useContext(CarouselContext)!;

    return (
      <div ref={ref} className="overflow-hidden" style={{ } as React.CSSProperties}>
        <div
...
const CarouselItem = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement> & { effects?: TechPanelEffects }>(
  ({ className, effects = 'on', ...props }, ref) => {
    const { orientation } = React.useContext(CarouselContext)!;
