...
const TerminalWindowToggle = forwardRef<React.ElementRef<typeof TogglePrimitives.Root>, React.ComponentPropsWithoutRef<typeof TogglePrimitives.Root> & { colors?: VariantColors; version?: string }>(
...
TerminalWindowToggle.displayName = 'TerminalWindowToggle';

export default TerminalWindowToggle;
