...
export const hexFrameClipPath = "polygon(10px 0, calc(100% - 10px) 0, 100% 10px, 100% calc(100% - 10px), calc(100% - 10px) 100%, 10px 100%, 0 calc(100% - 10px), 0 10px)"

export const honeyCombEffectsClass = (effects: HoneyCombEffects) => {
