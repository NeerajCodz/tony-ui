...
export default function Badge({
  ...
  const baseStyles = "relative backdrop-blur-md bg-opacity-20 border border-white/10 shadow-xl transition-all duration-200 inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2";
