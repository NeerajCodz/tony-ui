...
const MatrixGridToggle = forwardRef<React.ElementRef<typeof TogglePrimitives.Root>, React.ComponentPropsWithoutRef<typeof TogglePrimitives.Root> & { colors?: VariantColors; version?: string }>(
...
MatrixGridToggle.displayName = 'MatrixGridToggle';

export default MatrixGridToggle;
