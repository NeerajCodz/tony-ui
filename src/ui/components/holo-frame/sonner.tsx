...
const HoloFrameSonner = forwardRef<HTMLDivElement, SonnerProps>(
  ({ 
    colors,
    ...
    return (
      <div ref={ref} className={`sonner-container-holo-frame ${className}`}>
        <SonnerToaster
          position={position}
          expand={expand}
...
HoloFrameSonner.displayName = 'HoloFrameSonner';

export default HoloFrameSonner;
