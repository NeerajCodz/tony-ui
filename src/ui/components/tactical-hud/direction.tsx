...
const Component = React.forwardRef<HTMLDivElement, DirectionProps>(({ direction = 'right', size = 'md', className, version = 'tactical-hud', variant = 'primary', type = 'default', animated = true, children, ...props }, ref) => {
...
Component.displayName = "Direction-tactical-hud"
