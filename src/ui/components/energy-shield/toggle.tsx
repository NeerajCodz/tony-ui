...
const EnergyShieldToggle = forwardRef<React.ElementRef<typeof TogglePrimitives.Root>, React.ComponentPropsWithoutRef<typeof TogglePrimitives.Root> & { colors?: VariantColors; version?: string }>(
...
EnergyShieldToggle.displayName = 'EnergyShieldToggle';

export default EnergyShieldToggle;
