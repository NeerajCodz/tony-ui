...
const Component = React.forwardRef<HTMLDivElement, DirectionProps>(({ direction = 'right', size = 'md', className, version = 'compact', variant = 'primary', type = 'default', animated = true, children, ...props }, ref) => {
...
Component.displayName = "Direction-compact"
