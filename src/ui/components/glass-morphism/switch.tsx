...
const GlassMorphismSwitch = forwardRef<React.ElementRef<typeof SwitchPrimitives.Root>, SwitchProps>(
...
GlassMorphismSwitch.displayName = 'GlassMorphismSwitch';

export default GlassMorphismSwitch;
