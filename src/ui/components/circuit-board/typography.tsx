...
CircuitBoardList.displayName = 'CircuitBoardList';

export {
  CircuitBoardH1 as H1,
  CircuitBoardH2 as H2,
  CircuitBoardH3 as H3,
  CircuitBoardP as P,
  CircuitBoardBlockquote as Blockquote,
  CircuitBoardList as List,
};
