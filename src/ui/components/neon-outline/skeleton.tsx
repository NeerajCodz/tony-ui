/**
 * Skeleton - Neon Outline Version
 * Loading placeholder with neon outline styling
 */
...
export const Skeleton: React.FC<SkeletonProps> = ({
  ...
  const styles: React.CSSProperties = {
    ...
    position: 'relative',
    ...(animated && {
      animation: 'skeleton-pulse 1.5s ease-in-out infinite, skeleton-neon-glow 2s ease-in-out infinite',
    }),
    ...style,
  };
...
Skeleton.displayName = 'NeonOutlineSkeleton';
