...
const SelectTrigger = React.forwardRef<React.ElementRef<typeof SelectPrimitive.Trigger>, React.ComponentPropsWithoutRef<typeof SelectPrimitive.Trigger> & SelectProps>(({ type, className, children, variant = 'primary', ...props }, ref) => {
  ...
  return (
    <SelectPrimitive.Trigger
      ...
      style={{ border: `1px solid hsl(var(--${color}-base) / 0.5)`, boxShadow: `0 0 15px hsl(var(--${color}-base) / 0.2)`, background: `hsl(var(--${color}-base) / 0.1)`, backdropFilter: 'blur(5px)' }}
      {...props}
    >
      {children}
