...
const RaisedSwitch = forwardRef<React.ElementRef<typeof SwitchPrimitives.Root>, SwitchProps>(
...
RaisedSwitch.displayName = 'RaisedSwitch';

export default RaisedSwitch;
