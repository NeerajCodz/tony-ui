...
const Avatar = React.forwardRef<React.ComponentRef<typeof AvatarBase>, React.ComponentPropsWithoutRef<typeof AvatarBase>>(
  ({ className, ...props }, ref) => (
    <AvatarBase
      ref={ref}
      className={cn(
        'relative flex h-10 w-10 shrink-0 overflow-hidden rounded-none border border-[var(--br-border-dim)]',
        className
      )}
      {...props}
    />
...
const AvatarFallback = React.forwardRef<React.ComponentRef<typeof AvatarFallbackBase>, React.ComponentPropsWithoutRef<typeof AvatarFallbackBase>>(
  ({ className, ...props }, ref) => (
    <AvatarFallbackBase
      ref={ref}
      className={cn(
        'flex h-full w-full items-center justify-center rounded-none bg-muted font-mono font-medium',
        className
      )}
      {...props}
    />
