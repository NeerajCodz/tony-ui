...
const DataTable = <TData, TValue>({
  ...
  // @ts-ignore
  const currentStyle = versionStyles['terminal-window'] || versionStyles['angular-corner'];
    ...
    <div className={cn("w-full overflow-hidden", className)} style={{
      ...
      <div 
        ...
        style={{
          ...
          border: `2px solid hsl(var(--${color}-base))`, backgroundColor: 'black', fontFamily: 'monospace'
