...
export const Content = React.forwardRef(({ className, children, version = 'data-panel', variant = 'primary', ...props }: any, ref: any) => {
...
export const Title = React.forwardRef(({ className, version = 'data-panel', variant = 'primary', ...props }: any, ref: any) => {
  const color = variantColors[variant as keyof typeof variantColors] || 'cyan';
...
export const Description = React.forwardRef(({ className, version = 'data-panel', variant = 'primary', ...props }: any, ref: any) => {
  const color = variantColors[variant as keyof typeof variantColors] || 'cyan';
