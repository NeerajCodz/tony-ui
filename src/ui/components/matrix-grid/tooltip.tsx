...
const MatrixGridTooltipProvider = TooltipPrimitives.Provider;

const MatrixGridTooltip = TooltipPrimitives.Root;
...
MatrixGridTooltipContent.displayName = 'MatrixGridTooltipContent';

export {
  MatrixGridTooltip as Tooltip,
  MatrixGridTooltipTrigger as TooltipTrigger,
  MatrixGridTooltipContent as TooltipContent,
  MatrixGridTooltipProvider as TooltipProvider,
};
