...
const getVariantStyles = (variant: string = 'default') => {
  switch (variant) {
    case 'primary': return 'border-[var(--dp-accent)]/30 border-t-[var(--dp-accent)]';
    case 'secondary': return 'border-[var(--text-secondary)]/30 border-t-[var(--text-secondary)]';
    case 'accent': return 'border-[var(--dp-accent)]/30 border-t-[var(--dp-accent)]';
    case 'destructive': return 'border-[var(--dp-critical)]/30 border-t-[var(--dp-critical)]';
    case 'ghost': return 'border-[var(--text-muted)]/30 border-t-[var(--text-muted)]';
    default: return 'border-[var(--dp-accent)]/30 border-t-[var(--dp-accent)]';
  }
};
