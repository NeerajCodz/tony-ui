...
const GhostSonner = forwardRef<HTMLDivElement, SonnerProps>(
  ({ 
    colors,
    ...
    return (
      <div ref={ref} className={`sonner-container-ghost ${className}`}>
        <SonnerToaster
          position={position}
          expand={expand}
...
GhostSonner.displayName = 'GhostSonner';

export default GhostSonner;
