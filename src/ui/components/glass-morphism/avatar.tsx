...
export function Avatar({
  ...
  const baseStyles = "relative backdrop-blur-md bg-opacity-20 border border-white/10 shadow-xl transition-all duration-200 relative flex h-10 w-10 shrink-0 overflow-hidden rounded-full";
