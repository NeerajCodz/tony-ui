...
const ChartContainer = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof ChartContainerBase> & { effects?: TacticalHudEffects } & { chartType?: 'line' | 'bar' | 'pie' | 'area' | 'radar' | 'scatter' | 'composed' }
...
const ChartTooltipContent = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof ChartTooltipContentBase> & { effects?: TacticalHudEffects } & {
    hideLabel?: boolean;
...
const ChartLegendContent = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof ChartLegendContentBase> & { effects?: TacticalHudEffects }
