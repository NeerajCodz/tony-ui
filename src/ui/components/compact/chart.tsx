...
>(({ className, chartType, ...props }, ref) => {
  return (
    <ChartContainerBase
      ref={ref}
      className={cn(
        "flex aspect-video justify-center text-xs [&_.recharts-cartesian-axis-tick_text]:fill-[var(--text-muted)] [&_.recharts-cartesian-grid_line[stroke='#ccc']]:stroke-[var(--cp-border)]/50 [&_.recharts-curve.recharts-tooltip-cursor]:stroke-[var(--cp-border)] [&_.recharts-dot[stroke='#fff']]:stroke-transparent [&_.recharts-layer]:outline-none [&_.recharts-polar-grid_[stroke='#ccc']]:stroke-[var(--cp-border)] [&_.recharts-radial-bar-background-sector]:fill-[var(--text-muted)] [&_.recharts-rectangle.recharts-tooltip-cursor]:fill-[var(--text-muted)] [&_.recharts-reference-line_[stroke='#ccc']]:stroke-[var(--cp-border)] [&_.recharts-sector[stroke='#fff']]:stroke-transparent [&_.recharts-sector]:outline-none [&_.recharts-surface]:outline-none font-mono",
        className
      )}
      {...props}
    >
...
>(({ className, indicator = 'dot', hideLabel = false, hideIndicator = false, label, payload, active, ...props }, ref) => {
  ...
  return (
    <div
      ref={ref}
      className={cn(
        'grid min-w-[8rem] items-start gap-1.5 border border-[var(--cp-border)] bg-[var(--cp-bg)] px-2.5 py-1.5 text-xs shadow-xl',
        className
      )}
    >
