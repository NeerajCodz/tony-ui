...
const PaddingSwitch = forwardRef<React.ElementRef<typeof SwitchPrimitives.Root>, SwitchProps>(
...
PaddingSwitch.displayName = 'PaddingSwitch';

export default PaddingSwitch;
