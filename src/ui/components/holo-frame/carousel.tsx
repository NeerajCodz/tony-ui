    ...
    return (
      ...
      >
        <div
          ...
          className={cn(holoFrameEffectsClass(effects), 'relative', className)}
          role="region"
...
const CarouselContent = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement> & { effects?: HoloFrameEffects }>(
...
const CarouselItem = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement> & { effects?: HoloFrameEffects }>(
  ({ className, effects = 'on', ...props }, ref) => {
    const { orientation } = React.useContext(CarouselContext)!;
