...
const HoloFrameSpinner = forwardRef<HTMLDivElement, SpinnerProps>(
  ({ size = 'md', colors, type, className = '', style, ...props }, ref) => {
    ...
    return (
      <div
        ref={ref}
        className={`spinner-holo-frame relative inline-flex items-center justify-center ${className}`}
        style={{
          color: fg,
          ...style,
        }}
...
HoloFrameSpinner.displayName = 'HoloFrameSpinner';

export default HoloFrameSpinner;
