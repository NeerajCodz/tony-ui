      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-12">
          <h1 className="text-4xl font-bold mb-4 text-cyan-400 font-mono tracking-tighter">
            Spinner <span className="text-gray-600 text-2xl">// Loading State</span>
          </h1>
          <p className="text-gray-400 max-w-2xl">
            Cyber-aesthetic loading spinners. 
            ...
            <div key={version} className="p-8 border border-gray-800 rounded-lg bg-gray-900/50 flex flex-col gap-6 min-h-[200px] items-center justify-center">
              ...
              <div className="flex-1 flex flex-col gap-6 items-center justify-center w-full">
                <div className="flex items-center gap-8">
                   <Spinner version={version as any} size="sm" />
                   <Spinner version={version as any} size="md" />
                   <Spinner version={version as any} size="lg" />
                </div>
                <p className="text-xs font-mono text-gray-500 animate-pulse">PROCESSING...</p>
              </div>
            </div>
          ))}
        </div>
