      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-12">
          <h1 className="text-4xl font-bold mb-4 text-cyan-400 font-mono tracking-tighter">
            Select <span className="text-gray-600 text-2xl">// Component Showcase</span>
          </h1>
          <p className="text-gray-400 max-w-2xl">
            Cyber-aesthetic versions of the Select component. 
              ...
              <div className="min-h-[100px] w-full">
                ...
                >
                  <Select.Trigger className="w-full">
                    <Select.Value placeholder="Select System Module" />
                  </Select.Trigger>
                  <Select.Content>
                    <Select.Group>
                      <Select.Label>Core Modules</Select.Label>
                      <Select.Item value="nav">Navigation System</Select.Item>
                      <Select.Item value="warp">Warp Drive</Select.Item>
                      <Select.Item value="life">Life Support</Select.Item>
                      <Select.Separator />
                      <Select.Label>Defense Modules</Select.Label>
                      <Select.Item value="shield">Shield Generator</Select.Item>
                      <Select.Item value="turret">Auto-Turrets</Select.Item>
                    </Select.Group>
                  </Select.Content>
                </Select>
              </div>
