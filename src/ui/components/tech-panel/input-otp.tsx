...
export function InputOTPSlot({
  ...
  const baseStyles = "relative transition-all duration-200 border-2 relative flex h-10 w-10 items-center justify-center border-y border-r border-input text-sm transition-all first:rounded-l-md first:border-l last:rounded-r-md";
