...
>(({ className, orientation = "vertical", ...props }, ref) => (
  <ScrollAreaPrimitive.ScrollAreaScrollbar
    ...
    {...props}
  >
    <ScrollAreaPrimitive.ScrollAreaThumb className="relative flex-1 rounded-none bg-[var(--ne-primary)] shadow-[0_0_5px_var(--ne-primary)] hover:shadow-[0_0_10px_var(--ne-primary)]" />
  </ScrollAreaPrimitive.ScrollAreaScrollbar>
))
