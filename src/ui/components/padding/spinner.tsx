...
const PaddingSpinner = forwardRef<HTMLDivElement, SpinnerProps>(
  ({ size = 'md', colors, type, className = '', style, ...props }, ref) => {
    ...
    return (
      <div
        ref={ref}
        className={`spinner-padding relative inline-flex items-center justify-center ${className}`}
        style={{
          color: fg,
          ...style,
        }}
...
PaddingSpinner.displayName = 'PaddingSpinner';

export default PaddingSpinner;
