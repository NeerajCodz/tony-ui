    ...
    return (
      <KbdBase
        className={cn(holoFrameEffectsClass(effects), 
          'pointer-events-none inline-flex h-5 select-none items-center gap-1 rounded border border-[var(--hf-border-dim)] bg-[var(--hf-surface)] px-1.5 font-mono text-[10px] font-medium text-[var(--hf-text)] opacity-100',
          className
        )}
