...
const MatrixGridTextarea = forwardRef<HTMLTextAreaElement, TextareaProps>(
...
MatrixGridTextarea.displayName = 'MatrixGridTextarea';

export default MatrixGridTextarea;
