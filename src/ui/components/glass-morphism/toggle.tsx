...
const GlassMorphismToggle = forwardRef<React.ElementRef<typeof TogglePrimitives.Root>, React.ComponentPropsWithoutRef<typeof TogglePrimitives.Root> & { colors?: VariantColors; version?: string }>(
...
GlassMorphismToggle.displayName = 'GlassMorphismToggle';
