...
export default function Item({
  ...
  const baseStyles = "relative font-mono transition-all duration-200 bg-circuit-pattern flex items-center gap-2 p-2 rounded-md hover:bg-accent hover:text-accent-foreground transition-colors";
