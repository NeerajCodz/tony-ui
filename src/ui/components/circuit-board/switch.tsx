...
const CircuitBoardSwitch = forwardRef<React.ElementRef<typeof SwitchPrimitives.Root>, SwitchProps>(
...
CircuitBoardSwitch.displayName = 'CircuitBoardSwitch';

export default CircuitBoardSwitch;
