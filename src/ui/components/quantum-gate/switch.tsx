    ...
    return (
      <SwitchBase
        ...
        className={cn(quantumGateEffectsClass(effects), 
          'peer inline-flex shrink-0 cursor-pointer items-center border border-(--qg-border) transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-(--qg-iris-1) focus-visible:ring-offset-2 focus-visible:ring-offset-(--qg-bg) disabled:cursor-not-allowed disabled:opacity-50',
          'data-[state=checked]:bg-(--qg-iris-1) data-[state=unchecked]:bg-(--qg-bg)',
          getSizeStyles(size),
          className
        )}
        {...props}
      >
        <SwitchThumbBase
          className={cn(quantumGateEffectsClass(effects), 
            'pointer-events-none block bg-(--qg-iris-1) shadow-lg ring-0 transition-transform data-[state=checked]:bg-(--qg-bg)',
