...
const CLIP_PATH = 'polygon(10px 0, 50px 0, 60px 10px, 100% 10px, 100% calc(100% - 10px), calc(100% - 50px) 100%, 10px 100%, 0 calc(100% - 10px), 0 10px)';
...
Component.displayName = 'Calendar-circuit-board';
