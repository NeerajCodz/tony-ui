  ...
  return (
    <div
      ...
      className={cn(quantumGateEffectsClass(effects), 
        'flex h-[450px] shrink-0 items-center justify-center rounded border border-[var(--qg-border)] border-dashed bg-[var(--qg-surface)]',
        className
      )}
      {...props}
    >
      <div className="mx-auto flex max-w-[420px] flex-col items-center justify-center text-center">
        <div className="flex h-20 w-20 items-center justify-center rounded-full bg-[var(--qg-iris-1)]/10">
          <PackageOpen className="h-10 w-10 text-[var(--qg-iris-1)]" />
        </div>
