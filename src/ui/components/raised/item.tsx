...
export default function Item({
  ...
  const baseStyles = "relative transition-all duration-200 shadow-md active:shadow-sm active:translate-y-0.5 flex items-center gap-2 p-2 rounded-md hover:bg-accent hover:text-accent-foreground transition-colors";
