...
const ChartContainer = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof ChartContainerBase> & { effects?: QuantumGateEffects } & { chartType?: 'line' | 'bar' | 'pie' | 'area' | 'radar' | 'scatter' | 'composed' }
>(({ className, effects = 'on', chartType, ...props }, ref) => {
  return (
    <ChartContainerBase
      ref={ref}
      className={cn(quantumGateEffectsClass(effects), 
        "flex aspect-video justify-center text-xs [&_.recharts-cartesian-axis-tick_text]:fill-[var(--text-muted)] [&_.recharts-cartesian-grid_line[stroke='#ccc']]:stroke-[var(--qg-border)]/50 [&_.recharts-curve.recharts-tooltip-cursor]:stroke-[var(--qg-border)] [&_.recharts-dot[stroke='#fff']]:stroke-transparent [&_.recharts-layer]:outline-none [&_.recharts-polar-grid_[stroke='#ccc']]:stroke-[var(--qg-border)] [&_.recharts-radial-bar-background-sector]:fill-[var(--text-muted)] [&_.recharts-rectangle.recharts-tooltip-cursor]:fill-[var(--text-muted)] [&_.recharts-reference-line_[stroke='#ccc']]:stroke-[var(--qg-border)] [&_.recharts-sector[stroke='#fff']]:stroke-transparent [&_.recharts-sector]:outline-none [&_.recharts-surface]:outline-none font-sans",
        className
      )}
      {...props}
    >
...
const ChartTooltipContent = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof ChartTooltipContentBase> & { effects?: QuantumGateEffects } & {
    hideLabel?: boolean;
...
const ChartLegendContent = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof ChartLegendContentBase> & { effects?: QuantumGateEffects }
