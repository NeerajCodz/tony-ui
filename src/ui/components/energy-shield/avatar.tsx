...
export function Avatar({
  ...
  const baseStyles = "relative transition-all duration-200 rounded-lg shadow-[0_0_15px_rgba(0,0,0,0.5)] relative flex h-10 w-10 shrink-0 overflow-hidden rounded-full";
