...
const CLIP_PATH = 'polygon(10px 0, 40px 0, 50px 10px, 80px 10px, 90px 0, 100% 0, 100% calc(100% - 10px), calc(100% - 40px) 100%, 10px 100%, 0 calc(100% - 10px), 0 10px)';
...
Component.displayName = 'Chart-circuit-board';
