  ...
  return (
    <DrawerPortal>
      ...
      <DrawerPrimitive.Content
        ref={ref}
        className={cn(
          "fixed inset-x-0 bottom-0 z-50 mt-24 flex h-auto flex-col rounded-t-[10px] border-t-2 bg-black/95 backdrop-blur-md",
          className
        )}
        style={{
          borderColor: colors.border,
          boxShadow: `0 -4px 20px ${colors.glow}40`,
...
>(({ className, ...props }, ref) => (
  <DrawerPrimitive.Title
    ref={ref}
    className={cn(
      "text-lg font-semibold leading-none tracking-tight font-mono uppercase",
      className
    )}
    {...props}
  />
