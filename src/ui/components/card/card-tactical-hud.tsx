...
const CLIP_PATH = 'polygon(15px 0, calc(100% - 15px) 0, 100% 15px, 100% calc(100% - 15px), calc(100% - 15px) 100%, 15px 100%, 0 calc(100% - 15px), 0 15px)';
...
const Component = React.forwardRef<HTMLDivElement, CardProps>(({
  ...
  return (
    ...
    >
      ...
      {/* Targeting brackets */}
      <div className="absolute top-2 left-2 w-4 h-4 border-t-2 border-l-2" style={{ borderColor: `var(--${color})` }} />
      <div className="absolute top-2 right-2 w-4 h-4 border-t-2 border-r-2" style={{ borderColor: `var(--${color})` }} />
      <div className="absolute bottom-2 left-2 w-4 h-4 border-b-2 border-l-2" style={{ borderColor: `var(--${color})` }} />
      <div className="absolute bottom-2 right-2 w-4 h-4 border-b-2 border-r-2" style={{ borderColor: `var(--${color})` }} />
...
Component.displayName = 'Card-tactical-hud';
