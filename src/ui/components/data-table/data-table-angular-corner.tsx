...
const DataTable = <TData, TValue>({
  ...
  // @ts-ignore
  const currentStyle = versionStyles['angular-corner'] || versionStyles['angular-corner'];
    ...
    <div className={cn("w-full overflow-hidden", className)} style={{
      ...
      <div 
        ...
        style={{
          ...
          clipPath: 'polygon(10px 0, 100% 0, 100% calc(100% - 10px), calc(100% - 10px) 100%, 0 100%, 0 10px)', backgroundColor: `hsl(var(--${color}-base) / 0.05)`, border: `1px solid hsl(var(--${color}-base) / 0.5)`
