...
const QuantumGateTextarea = forwardRef<HTMLTextAreaElement, TextareaProps>(
...
QuantumGateTextarea.displayName = 'QuantumGateTextarea';

export default QuantumGateTextarea;