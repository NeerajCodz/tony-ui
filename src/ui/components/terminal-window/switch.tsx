...
const TerminalWindowSwitch = forwardRef<React.ElementRef<typeof SwitchPrimitives.Root>, SwitchProps>(
...
TerminalWindowSwitch.displayName = 'TerminalWindowSwitch';

export default TerminalWindowSwitch;
