...
export const sonnerConfig = {
  ...
  types: {
    default: {
      ...
      boxShadow: '0 0 25px hsl(var(--primary)), 0 0 50px hsl(var(--primary) / 0.5), inset 0 0 15px hsl(var(--primary) / 0.2)',
    } as CSSProperties,
    ...
    filled: {
      ...
      borderColor: 'hsl(var(--primary))',
      color: '#000',
      boxShadow: '0 0 30px hsl(var(--primary)), 0 0 60px hsl(var(--primary) / 0.6)',
      fontWeight: 600,
    } as CSSProperties,
    ...
    outline: {
      ...
      boxShadow: 'inset 0 0 15px hsl(var(--primary) / 0.5), 0 0 20px hsl(var(--primary)), 0 0 40px hsl(var(--primary) / 0.4)',
