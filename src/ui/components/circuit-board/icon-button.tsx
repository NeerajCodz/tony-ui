...
export default function IconButton({
  ...
  const baseStyles = "relative font-mono transition-all duration-200 bg-circuit-pattern p-2 inline-flex items-center justify-center rounded-md transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50";
