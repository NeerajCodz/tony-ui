...
const ContextMenuSubContent = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof ContextMenuPrimitive.SubContent> & { effects?: TerminalWindowEffects }
...
const ContextMenuContent = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof ContextMenuPrimitive.Content> & { effects?: TerminalWindowEffects }
>(({ className, effects = 'on', ...props }, ref) => (
  <ContextMenuPrimitive.Portal>
    <ContextMenuPrimitive.Content
      ref={ref}
      className={cn(terminalWindowEffectsClass(effects), 
        'z-50 min-w-[8rem] overflow-hidden rounded-none border border-[var(--tm-phosphor)] bg-[var(--tm-bg)] p-1 text-[var(--tm-phosphor)] shadow-md animate-in fade-in-80 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2',
        className
      )}
      {...props}
    />
...
const ContextMenuCheckboxItem = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof ContextMenuPrimitive.CheckboxItem> & { effects?: TerminalWindowEffects }
...
const ContextMenuRadioItem = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof ContextMenuPrimitive.RadioItem> & { effects?: TerminalWindowEffects }
...
const ContextMenuSeparator = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof ContextMenuPrimitive.Separator> & { effects?: TerminalWindowEffects }
>(({ className, effects = 'on', ...props }, ref) => (
