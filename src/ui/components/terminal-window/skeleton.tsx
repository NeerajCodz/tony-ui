/**
 * Skeleton - Terminal Window Version
 * Loading placeholder with terminal window styling
 */
...
export const Skeleton: React.FC<SkeletonProps> = ({
  ...
  const styles: React.CSSProperties = {
    ...
    clipPath: CLIP_PATHS['terminal-window']?.small || 'polygon(0 0, calc(100% - 12px) 0, 100% 12px, 100% 100%, 0 100%)',
...
Skeleton.displayName = 'TerminalWindowSkeleton';
