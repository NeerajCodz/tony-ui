...
export default function Label({
  ...
  const baseStyles = "relative backdrop-blur-md bg-opacity-20 border border-white/10 shadow-xl transition-all duration-200 text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70";
