...
export default function Label({
  ...
  const baseStyles = "relative transition-all duration-200 rounded-md text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70";
