...
const getVariantStyles = (variant: string = 'default') => {
  switch (variant) {
    case 'primary': return 'border-[var(--es-plasma-1)]/30 border-t-[var(--es-plasma-1)]';
    case 'secondary': return 'border-[var(--text-secondary)]/30 border-t-[var(--text-secondary)]';
    case 'accent': return 'border-[var(--es-plasma-1)]/30 border-t-[var(--es-plasma-1)]';
    case 'destructive': return 'border-[var(--es-plasma-3)]/30 border-t-[var(--es-plasma-3)]';
    case 'ghost': return 'border-[var(--text-muted)]/30 border-t-[var(--text-muted)]';
    default: return 'border-[var(--es-plasma-1)]/30 border-t-[var(--es-plasma-1)]';
  }
};
