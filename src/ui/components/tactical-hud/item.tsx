...
export default function Item({
  ...
  const baseStyles = "relative font-mono tracking-tight transition-all duration-200 border-x flex items-center gap-2 p-2 rounded-md hover:bg-accent hover:text-accent-foreground transition-colors";
