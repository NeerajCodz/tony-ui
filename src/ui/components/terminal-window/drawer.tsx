...
export const Overlay = React.forwardRef(({ className, version = 'terminal-window', ...props }: any, ref: any) => (
...
export const Content = React.forwardRef(({ className, children, version = 'terminal-window', type = 'default', variant = 'primary', ...props }: any, ref: any) => {
...
export const Title = React.forwardRef(({ className, version = 'terminal-window', type = 'default', variant = 'primary', ...props }: any, ref: any) => {
  const color = variantColors[variant as keyof typeof variantColors] || 'cyan';
...
export const Description = React.forwardRef(({ className, version = 'terminal-window', type = 'default', variant = 'primary', ...props }: any, ref: any) => {
  const color = variantColors[variant as keyof typeof variantColors] || 'cyan';
