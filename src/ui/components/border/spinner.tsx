...
const BorderSpinner = forwardRef<HTMLDivElement, SpinnerProps>(
  ({ size = 'md', colors, type, className = '', style, ...props }, ref) => {
    ...
    return (
      <div
        ref={ref}
        className={`spinner-border relative inline-flex items-center justify-center ${className}`}
        style={{
          color: fg,
          ...style,
        }}
...
BorderSpinner.displayName = 'BorderSpinner';
