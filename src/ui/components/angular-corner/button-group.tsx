...
export default function ButtonGroup({
  ...
  const baseStyles = "relative font-mono uppercase tracking-wider transition-all duration-200 clip-path-angular inline-flex -space-x-px rounded-md shadow-sm";
