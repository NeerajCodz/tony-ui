...
const DataTable = <TData, TValue>({
  ...
  // @ts-ignore
  const currentStyle = versionStyles['holo-frame'] || versionStyles['angular-corner'];
    ...
    <div className={cn("w-full overflow-hidden", className)} style={{
      ...
      <div 
        ...
        style={{
          ...
          boxShadow: `0 0 15px hsl(var(--${color}-base) / 0.1)`, border: `1px solid hsl(var(--${color}-base) / 0.3)`, backgroundColor: `hsl(var(--${color}-base) / 0.02)`
