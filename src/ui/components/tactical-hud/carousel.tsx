    ...
    return (
      ...
      >
        <div
          ...
          className={cn(tacticalHudEffectsClass(effects), 'relative', className)}
          role="region"
...
const CarouselContent = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement> & { effects?: TacticalHudEffects }>(
  ({ className, effects = 'on', ...props }, ref) => {
    const { orientation } = React.useContext(CarouselContext)!;

    return (
      <div className="overflow-hidden" style={{ '--corner': '16px' } as React.CSSProperties}>
        <div
          ref={ref}
...
const CarouselItem = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement> & { effects?: TacticalHudEffects }>(
  ({ className, effects = 'on', ...props }, ref) => {
    const { orientation } = React.useContext(CarouselContext)!;
...
const CarouselPrevious = React.forwardRef<HTMLButtonElement, React.ComponentProps<typeof Button>>(
  ({ className, effects = 'on', visualType = 'outline', size = 'icon', ...props }, ref) => {
