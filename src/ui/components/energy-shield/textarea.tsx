...
const EnergyShieldTextarea = forwardRef<HTMLTextAreaElement, TextareaProps>(
...
EnergyShieldTextarea.displayName = 'EnergyShieldTextarea';

export default EnergyShieldTextarea;