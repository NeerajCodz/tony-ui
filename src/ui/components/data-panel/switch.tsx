...
const DataPanelSwitch = forwardRef<React.ElementRef<typeof SwitchPrimitives.Root>, SwitchProps>(
...
DataPanelSwitch.displayName = 'DataPanelSwitch';

export default DataPanelSwitch;
