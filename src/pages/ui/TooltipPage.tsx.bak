      ...
      <div className='max-w-7xl mx-auto'>
        <div className='mb-12'>
          <h1 className='text-4xl font-bold mb-4 text-cyan-400 font-mono tracking-tighter'>
            Tooltip <span className='text-gray-600 text-2xl'>// Component Showcase</span>
          </h1>
          <p className='text-gray-400 max-w-2xl'>
            Cyber-aesthetic versions of the Tooltip component. 
                    ...
                    >
                      ...
                      <Tooltip.Content side='top'>
                        <div className='flex flex-col gap-1'>
                          <span className='font-bold text-xs uppercase tracking-widest'>System Info</span>
                          <span className='text-xs opacity-80'>Component version verified.</span>
                        </div>
                      </Tooltip.Content>
                    </Tooltip>
                  </div>
