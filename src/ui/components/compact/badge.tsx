...
export default function Badge({
  ...
  const baseStyles = "relative text-sm transition-all duration-200 inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2";
