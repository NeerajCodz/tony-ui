...
export const DropdownMenuContent = ({ className, sideOffset = 4, ...props }: any) => {
  return <DropdownMenuPrimitive.Portal><DropdownMenuPrimitive.Content sideOffset={sideOffset} className={cn(contentStyle, className)} {...props} /></DropdownMenuPrimitive.Portal>;
};
...
export const DropdownMenuSubContent = ({ className, ...props }: any) => {
  return <DropdownMenuPrimitive.SubContent className={cn(contentStyle, className)} {...props} />;
};
