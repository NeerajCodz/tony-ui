...
const CLIP_PATH = 'polygon(8px 0, calc(100% - 8px) 0, 100% 8px, 100% calc(100% - 8px), calc(100% - 8px) 100%, 8px 100%, 0 calc(100% - 8px), 0 8px)';
...
const Component = React.forwardRef<HTMLDivElement, CardProps>(({
  ...
  return (
    ...
    >
      ...
      {/* Corner pixels */}
      <div className="absolute top-1 left-2 w-1 h-1" style={{ background: `var(--${color})` }} />
      <div className="absolute top-1 right-2 w-1 h-1" style={{ background: `var(--${color})` }} />
      <div className="absolute bottom-1 left-2 w-1 h-1" style={{ background: `var(--${color})` }} />
      <div className="absolute bottom-1 right-2 w-1 h-1" style={{ background: `var(--${color})` }} />
...
Component.displayName = 'Card-matrix-grid';
