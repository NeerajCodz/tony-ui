...
>(({ className, children, ...props }, ref) => (
  <DrawerPortal>
    ...
    <DrawerPrimitive.Content
      ref={ref}
      className={cn(
        'fixed inset-x-0 bottom-0 z-50 mt-24 flex h-auto flex-col border border-[var(--mg-border)] bg-[var(--mg-surface)] shadow-lg',
      ...
      {...props}
    >
      <div className="mx-auto mt-4 h-2 w-[100px] bg-[var(--mg-border)]" />
      {children}
    </DrawerPrimitive.Content>
  </DrawerPortal>
));
...
>(({ className, ...props }, ref) => (
  <DrawerPrimitive.Title
    ref={ref}
    className={cn(
      'text-lg font-semibold leading-none tracking-tight text-[var(--mg-accent)] uppercase font-mono',
      className
    )}
    {...props}
  />
