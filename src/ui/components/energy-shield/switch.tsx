...
const EnergyShieldSwitch = forwardRef<React.ElementRef<typeof SwitchPrimitives.Root>, SwitchProps>(
...
EnergyShieldSwitch.displayName = 'EnergyShieldSwitch';

export default EnergyShieldSwitch;
