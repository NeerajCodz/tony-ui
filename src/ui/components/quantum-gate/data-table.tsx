...
const DataTable = <TData, TValue>({
  ...
  return (
    <div className={cn("w-full overflow-hidden", className)} style={{
      clipPath: 'polygon(20px 0, 100% 0, 100% calc(100% - 20px), calc(100% - 20px) 100%, 0 100%, 0 20px)', border: `1px solid hsl(var(--${color}-base) / 0.4)`, background: `hsl(var(--${color}-base) / 0.05)`
    }}>
      <div 
      ...
      >
        <table className="w-full caption-bottom text-sm">
          <thead style={{
             background: `hsl(var(--${color}-base) / 0.15)`, clipPath: 'polygon(0 0, 100% 0, 98% 100%, 2% 100%)'
          }}>
