...
const CompactSonner = forwardRef<HTMLDivElement, SonnerProps>(
  ({ 
    colors,
...
CompactSonner.displayName = 'CompactSonner';

export default CompactSonner;