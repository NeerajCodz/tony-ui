...
const AngularCornerTextarea = forwardRef<HTMLTextAreaElement, TextareaProps>(
...
AngularCornerTextarea.displayName = 'AngularCornerTextarea';

export default AngularCornerTextarea;