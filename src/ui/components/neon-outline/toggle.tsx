...
const NeonOutlineToggle = forwardRef<React.ElementRef<typeof TogglePrimitives.Root>, React.ComponentPropsWithoutRef<typeof TogglePrimitives.Root> & { colors?: VariantColors; version?: string }>(
...
NeonOutlineToggle.displayName = 'NeonOutlineToggle';

export default NeonOutlineToggle;
