...
const versionStyles = {
  'angular-corner': cva(
    "inline-flex items-center justify-center whitespace-nowrap text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 clip-path-bevel active:scale-95",
    {
      variants: {
        variant: {
          default: "bg-cyan-600/90 text-white hover:bg-cyan-500/90 border-l-4 border-cyan-400 backdrop-blur-[2px]",
          destructive: "bg-red-700/90 text-white hover:bg-red-600/90 border-l-4 border-red-400 backdrop-blur-[2px]",
          outline: "border border-cyan-700/80 text-cyan-500 hover:bg-cyan-950/50 backdrop-blur-sm",
          secondary: "bg-cyan-900/80 text-cyan-300 hover:bg-cyan-800/80 backdrop-blur-sm",
  ...
  'holo-frame': cva(
    "inline-flex items-center justify-center whitespace-nowrap text-sm font-bold ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border backdrop-blur-sm rounded-none shadow-[0_0_10px_rgba(6,182,212,0.1)] hover:shadow-[0_0_15px_rgba(6,182,212,0.4)] clip-path-shards",
    {
      variants: {
        variant: {
  ...
  'data-panel': cva(
    "inline-flex items-center justify-center whitespace-nowrap text-sm font-mono tracking-wider ring-offset-background transition-none focus-visible:outline-none disabled:pointer-events-none disabled:opacity-50 rounded-none border-2 clip-path-step",
    {
      variants: {
        variant: {
  ...
  'circuit-board': cva(
    "inline-flex items-center justify-center whitespace-nowrap text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 rounded-none border-b-2 active:border-b-0 active:translate-y-[2px] clip-path-tag",
    {
      variants: {
        variant: {
  ...
  'matrix-grid': cva(
    "inline-flex items-center justify-center whitespace-nowrap text-sm font-bold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 rounded-none border hover:shadow-[0_0_10px_rgba(132,204,22,0.5)] clip-path-angle",
    {
      variants: {
        variant: {
  ...
  'neon-outline': cva(
    "inline-flex items-center justify-center whitespace-nowrap text-sm font-bold ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 rounded-none border-2 shadow-[0_0_5px_rgba(217,70,239,0.5)] hover:shadow-[0_0_15px_rgba(217,70,239,0.8)] clip-path-slant",
    {
      variants: {
        variant: {
