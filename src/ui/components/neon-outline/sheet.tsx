...
const SheetContent = React.forwardRef<React.ElementRef<typeof SheetPrimitive.Content>, SheetContentProps>(({ side = "right", className, children, variant = "primary", ...props }, ref) => {
  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        style={{
            border: `2px solid hsl(var(--${color}-base))`, boxShadow: `0 0 5px hsl(var(--${color}-base)), inset 0 0 5px hsl(var(--${color}-base))`
        }}
        {...props}
      >
        {children}
