...
const CLIP_PATH = 'polygon(0 0, calc(100% - 18px) 0, 100% 18px, 100% 100%, 18px 100%, 0 calc(100% - 18px))';
...
case 'default':
  ...
  return (
    ...
    >
      ...
      {/* Circuit traces */}
      <div className="absolute top-0 left-[25%] w-[2px] h-4" style={{ background: `rgba(var(--${color}-rgb), 0.5)` }} />
      <div className="absolute top-4 left-[25%] w-6 h-[2px]" style={{ background: `rgba(var(--${color}-rgb), 0.5)` }} />
      <div className="absolute top-4 left-[calc(25%+22px)] w-2 h-2 rounded-full" style={{ background: `var(--${color})`, boxShadow: `0 0 6px var(--${color})` }} />
      <div className="absolute bottom-0 right-[30%] w-[2px] h-4" style={{ background: `rgba(var(--${color}-rgb), 0.5)` }} />
      <div className="absolute bottom-4 right-[30%] w-6 h-[2px]" style={{ background: `rgba(var(--${color}-rgb), 0.5)` }} />
...
Component.displayName = 'Card-circuit-board';
