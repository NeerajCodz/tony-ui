...
const BorderSonner = forwardRef<HTMLDivElement, SonnerProps>(
  ({ 
    colors,
    ...
    return (
      <div ref={ref} className={`sonner-container-border ${className}`}>
        <SonnerToaster
          position={position}
          expand={expand}
...
BorderSonner.displayName = 'BorderSonner';

export default BorderSonner;
