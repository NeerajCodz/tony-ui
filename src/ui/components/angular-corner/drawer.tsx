...
const styles = { overlay: "fixed inset-0 z-50 bg-black/60 backdrop-blur-sm", content: "fixed bottom-0 left-0 right-0 z-50 mt-24 flex h-auto flex-col rounded-t-[10px] border-t-2 bg-gray-950 clip-path-bevel-top", title: "text-lg font-semibold leading-none tracking-tight font-mono", description: "text-sm font-mono opacity-70"  };
...
export const Content = React.forwardRef(({ className, children, version = 'angular-corner', type = 'default', variant = 'primary', ...props }: any, ref: any) => {
...
export const Title = React.forwardRef(({ className, version = 'angular-corner', type = 'default', variant = 'primary', ...props }: any, ref: any) => {
  const color = variantColors[variant as keyof typeof variantColors] || 'cyan';
...
export const Description = React.forwardRef(({ className, version = 'angular-corner', type = 'default', variant = 'primary', ...props }: any, ref: any) => {
  const color = variantColors[variant as keyof typeof variantColors] || 'cyan';
