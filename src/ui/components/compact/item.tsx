...
export default function Item({
  ...
  const baseStyles = "relative text-sm transition-all duration-200 flex items-center gap-2 p-2 rounded-md hover:bg-accent hover:text-accent-foreground transition-colors";
