...
const versionComponents = {
  'angular-corner': lazy(() => import('./empty-state-angular-corner')),
  'holo-frame': lazy(() => import('./empty-state-holo-frame')),
  'data-panel': lazy(() => import('./empty-state-data-panel')),
  'circuit-board': lazy(() => import('./empty-state-circuit-board')),
  'quantum-gate': lazy(() => import('./empty-state-quantum-gate')),
  'tactical-hud': lazy(() => import('./empty-state-tactical-hud')),
  'energy-shield': lazy(() => import('./empty-state-energy-shield')),
  'terminal-window': lazy(() => import('./empty-state-terminal-window')),
  'matrix-grid': lazy(() => import('./empty-state-matrix-grid')),
  'neon-outline': lazy(() => import('./empty-state-neon-outline')),
};
...
`;
  ...
  fs.writeFileSync(path.join(targetDir, `empty-state-${version}.tsx`), versionContent);
});

console.log('EmptyState regeneration complete.');
