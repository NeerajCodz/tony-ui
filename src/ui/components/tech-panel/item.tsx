...
export default function Item({
  ...
  const baseStyles = "relative transition-all duration-200 border-2 flex items-center gap-2 p-2 rounded-md hover:bg-accent hover:text-accent-foreground transition-colors";
