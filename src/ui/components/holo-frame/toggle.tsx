...
const HoloFrameToggle = forwardRef<React.ElementRef<typeof TogglePrimitives.Root>, React.ComponentPropsWithoutRef<typeof TogglePrimitives.Root> & { colors?: VariantColors; version?: string }>(
...
HoloFrameToggle.displayName = 'HoloFrameToggle';

export default HoloFrameToggle;
