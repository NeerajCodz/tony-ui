  ...
  ({ className, size = 'md', style, ...props }, ref) => {
    return (
      <SwitchBase
        ...
        className={cn(
          'peer inline-flex shrink-0 cursor-pointer items-center border border-[var(--cp-border)] transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-[var(--cp-accent)] focus-visible:ring-offset-2 focus-visible:ring-offset-[var(--cp-bg)] disabled:cursor-not-allowed disabled:opacity-50',
          'data-[state=checked]:bg-[var(--cp-accent)] data-[state=unchecked]:bg-[var(--cp-bg)]',
          getSizeStyles(size),
          className
        )}
        {...props}
      >
        <SwitchThumbBase
          className={cn(
            'pointer-events-none block bg-[var(--cp-text)] shadow-lg ring-0 transition-transform data-[state=checked]:bg-[var(--cp-bg)]',
