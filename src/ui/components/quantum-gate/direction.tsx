...
const Component = React.forwardRef<HTMLDivElement, DirectionProps>(({ direction = 'right', size = 'md', className, version = 'quantum-gate', variant = 'primary', type = 'default', animated = true, children, ...props }, ref) => {
...
Component.displayName = "Direction-quantum-gate"
