...
export function AvatarPage() {
  ...
  const defaultProps = {"src":"https://github.com/shadcn.png","fallback":"CN"};
      ...
      <div className="max-w-7xl mx-auto">
        <div className="mb-12">
          <h1 className="text-4xl font-bold mb-4 text-cyan-400 font-mono tracking-tighter">
            Avatar <span className="text-gray-600 text-2xl">// Component Showcase</span>
          </h1>
          <p className="text-gray-400 max-w-2xl">
            Cyber-aesthetic versions of the Avatar component. 
