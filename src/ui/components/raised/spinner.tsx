...
const RaisedSpinner = forwardRef<HTMLDivElement, SpinnerProps>(
  ({ size = 'md', colors, type, className = '', style, ...props }, ref) => {
    ...
    return (
      <div
        ref={ref}
        className={`spinner-raised relative inline-flex items-center justify-center ${className}`}
        style={{
          color: fg,
          ...style,
        }}
...
RaisedSpinner.displayName = 'RaisedSpinner';

export default RaisedSpinner;
