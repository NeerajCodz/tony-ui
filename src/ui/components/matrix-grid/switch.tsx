...
const MatrixGridSwitch = forwardRef<React.ElementRef<typeof SwitchPrimitives.Root>, SwitchProps>(
...
MatrixGridSwitch.displayName = 'MatrixGridSwitch';

export default MatrixGridSwitch;
