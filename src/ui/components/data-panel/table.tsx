...
>(({ className, ...props }, ref) => (
  <TableHeaderBase ref={ref} className={cn('[&_tr]:border-b border-[var(--dp-border)]', className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <TableRowBase
    ref={ref}
    className={cn(
      'border-b border-[var(--dp-border)] transition-colors hover:bg-[var(--dp-accent)]/5 data-[state=selected]:bg-[var(--dp-accent)]/10',
      className
    )}
    {...props}
  />
