...
export function DataTable<TData, TValue>({
  ...
  return (
    <div className={cn(quantumGateEffectsClass(effects), 'w-full font-sans')}>
      ...
      <div className="rounded border border-[var(--qg-border)] bg-[var(--qg-surface)] p-1" style={{ '--corner': '8px' } as React.CSSProperties}>
        <Table>
          <TableHeader>
