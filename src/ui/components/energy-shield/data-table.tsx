...
const DataTable = <TData, TValue>({
  ...
  return (
    <div className={cn("w-full overflow-hidden", className)} style={{
      boxShadow: `0 0 20px hsl(var(--${color}-base) / 0.2), inset 0 0 20px hsl(var(--${color}-base) / 0.1)`, border: `1px solid hsl(var(--${color}-base) / 0.5)`, borderRadius: '8px', overflow: 'hidden'
    }}>
      <div 
