...
>(({ className, effects = 'on', ...props }, ref) => (
  <AlertDialogHeaderBase
    ref={ref}
    className={cn(quantumGateEffectsClass(effects), 'flex flex-col space-y-2 text-center sm:text-left', className)}
    {...props}
  />
));
...
>(({ className, effects = 'on', ...props }, ref) => (
  <AlertDialogFooterBase
    ref={ref}
    className={cn(quantumGateEffectsClass(effects), 'flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-2', className)}
    {...props}
  />
));
...
>(({ className, effects = 'on', ...props }, ref) => (
  <AlertDialogTitleBase
    ref={ref}
    className={cn(quantumGateEffectsClass(effects), 'text-lg font-sans font-bold uppercase tracking-wide', className)}
    {...props}
  />
));
...
>(({ className, effects = 'on', ...props }, ref) => (
  <AlertDialogDescriptionBase
    ref={ref}
    className={cn(quantumGateEffectsClass(effects), 'text-sm text-(--text-secondary) font-sans', className)}
    {...props}
  />
));
...
>(({ className, effects = 'on', ...props }, ref) => (
  <AlertDialogCancelBase ref={ref} asChild>
    <Button visualType="outline" className={cn(quantumGateEffectsClass(effects), 'mt-2 sm:mt-0', className)} {...props} />
