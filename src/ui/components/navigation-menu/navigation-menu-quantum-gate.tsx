...
export const NavigationMenuRoot = ({ className, children, ...props }: any) => {
  return (
    <NavigationMenuPrimitive.Root
      className={cn(getRootStyles('quantum-gate'), className)}
      {...props}
    >
      {children}
    </NavigationMenuPrimitive.Root>
...
export const NavigationMenuList = ({ className, ...props }: any) => {
  return (
    <NavigationMenuPrimitive.List
      className={cn(getListStyles('quantum-gate'), className)}
      {...props}
    />
  );
};
...
export const NavigationMenuTrigger = ({ className, children, ...props }: any) => {
  return (
    <NavigationMenuPrimitive.Trigger
      className={cn(getTriggerStyles('quantum-gate'), className)}
      {...props}
    >
      {children}
      <ChevronDown
...
export const NavigationMenuContent = ({ className, ...props }: any) => {
  return (
    <NavigationMenuPrimitive.Content
      className={cn(getContentStyles('quantum-gate'), className)}
      {...props}
    />
  );
};
  ...
  return (
    <div className={cn("absolute left-0 top-full flex justify-center")}>
      <NavigationMenuPrimitive.Viewport
        className={cn(getViewportStyles('quantum-gate'), className)}
        {...props}
      />
    </div>
  );
