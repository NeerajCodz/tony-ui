                  ...
                  <CommandGroup>
                    {options.map((option) => (
                      ...
                      >
                        <Check
                          className={cn(honeyCombEffectsClass(effects), 
                            'mr-2 h-4 w-4 text-[var(--hc-plasma-1)]',
...
export const ComboboxTrigger = React.forwardRef<HTMLButtonElement, React.ButtonHTMLAttributes<HTMLButtonElement> & { effects?: HoneyCombEffects }>(
