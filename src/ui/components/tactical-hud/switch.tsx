...
const TacticalHudSwitch = forwardRef<React.ElementRef<typeof SwitchPrimitives.Root>, SwitchProps>(
...
TacticalHudSwitch.displayName = 'TacticalHudSwitch';

export default TacticalHudSwitch;
