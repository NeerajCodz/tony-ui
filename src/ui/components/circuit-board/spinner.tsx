...
const CircuitBoardSpinner = forwardRef<HTMLDivElement, SpinnerProps>(
  ({ size = 'md', colors, type, className = '', style, ...props }, ref) => {
    ...
    return (
      <div
        ref={ref}
        className={`spinner-circuit-board relative inline-flex items-center justify-center ${className}`}
        style={{
          color: fg,
          ...style,
        }}
...
CircuitBoardSpinner.displayName = 'CircuitBoardSpinner';

export default CircuitBoardSpinner;
