...
export function DataTable<TData, TValue>({
  ...
  return (
    <div className="w-full font-mono">
      <div className="flex items-center py-4">
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button visualType="outline" className="ml-auto">
      ...
      <div className="rounded-none border border-[var(--ac-border)] bg-[var(--ac-surface)] p-1" style={{ clipPath: AC_CLIP_PATH, '--corner': '8px' } as React.CSSProperties}>
        <Table>
          <TableHeader>
