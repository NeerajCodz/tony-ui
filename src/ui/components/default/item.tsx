...
export default function Item({
  ...
  const baseStyles = "relative transition-all duration-200 rounded-md flex items-center gap-2 p-2 rounded-md hover:bg-accent hover:text-accent-foreground transition-colors";
