...
const ChartContainer = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof ChartContainerBase> & { effects?: HoloFrameEffects } & { chartType?: 'line' | 'bar' | 'pie' | 'area' | 'radar' | 'scatter' | 'composed' }
...
const ChartTooltipContent = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof ChartTooltipContentBase> & { effects?: HoloFrameEffects } & {
    hideLabel?: boolean;
...
const ChartLegendContent = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<typeof ChartLegendContentBase> & { effects?: HoloFrameEffects }
