...
export function DataTable<TData, TValue>({
  ...
  return (
    <div className={cn(holoFrameEffectsClass(effects), 'w-full font-mono')}>
      ...
      <div className="rounded border border-[var(--hf-border-dim)] bg-[var(--hf-surface)] p-1" style={{ '--corner': '8px' } as React.CSSProperties}>
        <Table>
          <TableHeader>
      ...
      <div className="flex items-center justify-end space-x-2 py-4">
        <div className="flex-1 text-sm text-[var(--hf-text)]">
