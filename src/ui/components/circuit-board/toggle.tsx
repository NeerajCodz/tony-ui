...
const CircuitBoardToggle = forwardRef<React.ElementRef<typeof TogglePrimitives.Root>, React.ComponentPropsWithoutRef<typeof TogglePrimitives.Root> & { colors?: VariantColors; version?: string }>(
...
CircuitBoardToggle.displayName = 'CircuitBoardToggle';

export default CircuitBoardToggle;
